...
referral_links = {
    ...
    "افکس": "https://efex.pro/fa/sign-up?ref=392773045109",  # جدید
    ...
    "ایرانیکارت": "https://panel.iranicard.ir/register?referralCode=29936688",  # جدید
    "بیت پین": "https://bitpin.ir/signup/?refcode=uepd2bmvjo",
    "والکس": "https://wallex.ir/signup?ref=RKna",
}

# صرافی‌های اصلی که همیشه باز و بدون جمع‌شدن نمایش داده می‌شوند
MAIN_EXCHANGES = [
    "آبان تتر",
    "نوبیتکس",
    "والکس",
...
def fetch_prices():
    # آدرس صفحه عوض شده و ساختار جدول هم تغییر کرده:
    # دیگه ستون‌های جدای «قیمت خرید»/«قیمت فروش» و «بروزرسانی» وجود نداره،
    # فقط «صرافی»، «عمق بازار» و «قیمت» هست.
    ...
    try:
        ...
        for row in table.find("tbody").find_all("tr"):
            ...
            # اگر اسم صرافی قبلاً دیده شده، ردیف تکراری رو نادیده بگیر (فقط اولی نگه داشته می‌شود)
...
if __name__ == '__main__':
    bot_token = '7623283021:AAF0lHWos-RGpJh8MuHeiBzwz4A_liz7yFc'
    async def main():
        bot = Bot(bot_token)
        await auto_send(bot)
